      ...
      items: [
        {
          ...
          value: `
            <a href="https://github.com/IbrahimXplorer/shadow-ui" 
               ...
               style="display:flex;align-items:center;color:#4287E8;text-decoration:none">
              <svg height="20" width="20" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                0 0 .67-.21 2.2.82a7.56 7.56 0 012-.27c.68.003 1.36.092 2 .27 
                1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.91.08 2.11.51.56.82 1.27.82 
        ...
        },
        {
          ...
          value: `
            <a href="https://www.linkedin.com/in/devibrahim/" 
               target="_blank" 
               rel="noopener noreferrer" 
               style="display:flex;align-items:center;color:#4287E8;text-decoration:none;margin-left:10px;">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                ...
                1.248h.014zm4.908 8.212h2.4v-4.045c0-.216.016-.432.08-.586.175-.432.574-.88 
                1.244-.88.88 0 1.233.664 1.233 1.636v3.875h2.4V9.72c0-2.255-1.204-3.305-2.81-3.305-1.296 
                0-1.87.715-2.187 1.218h.03v-1.045h-2.4c.03.687 
                0 7.225 0 7.225z"/>
              </svg>
            </a>
          `,
        },
        {
          ...
          position: "right",
          value: `
            <a href="mailto:khan.ask.ibrahim@gmail.com" 
              style="
                background-color: #4287E8;
                color: white;
                padding: 6px 20px;
                border-radius: 4px;
              ...
              "
              onmouseover="this.style.backgroundColor='#2f66b8'"
              onmouseout="this.style.backgroundColor='#4287E8'">
              Hire Me
            </a>
          `,
        },
